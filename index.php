...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide_text">
                                        <h3>WATER <br>QUALITY MONITORING SYSTEM</h3>
                                        <br>
                                        <h4><span class="theme_color">REAL-TIME WATER QUALITY MONITORNG</span></h4>
                                        <br>
                                        <p id="ty">Spatially collected pH,<br> Temparature, EC ,PH <br>Turbidity<br> approximations </p>
          ...
          <div class="row">
            <div class="col-md-3 footer1 d-flex wow bounceInLeft" data-wow-delay=".25s">
              <div class="d-flex flex-wrap align-content-center"> <a href="#"><img id="logo" src="images/logo.png" alt="logo" /></a>
                <p>We provide real-time spatially water quality variables data</p>
            ...
            <div class="col-md-3 footer3 wow bounceInRight" data-wow-delay=".25s">
              ...
              <p>Nyeri, CBD</p>
              <h5>PHONE</h5>
              <p><a href="# ">+254713297997</a></p>
              <h5>EMAIL</h5>
              <p> <a href="mail">wainainamartin@outlook.com</a> </p>
              <div class="social-links">
                <ul class="nav nav-item">
                    <li><a href="#"><i class="fa fa-facebook-f"></i></a></li>
                    <li><a href="@dennisnjoki4"><i class="fa fa-twitter"></i></a></li>
                    <!-- <li><a href="#"><i class="fa fa-linkedin"></i></a></li> -->
                    <li><a href="wainainamartin@outlook.comm"><i class="fa fa-google-plus"></i></a></li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <div class="footer_bottom">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p class="crp">© 2021 <br> All Rights Reserved.</p>
